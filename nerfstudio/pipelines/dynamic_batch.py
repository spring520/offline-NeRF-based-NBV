...
class DynamicBatchPipelineConfig(VanillaPipelineConfig):
    ...
    max_dynamic_num_rays_per_batch: int = int((262144-1)/3)
    """The maximum number of rays allowed in a batch."""
...
class DynamicBatchPipeline(VanillaPipeline):
    ...
    def _update_dynamic_num_rays_per_batch(self, num_samples_per_batch: int):
        ...
        self.dynamic_num_rays_per_batch = min(self.dynamic_num_rays_per_batch, self.config.max_dynamic_num_rays_per_batch)
