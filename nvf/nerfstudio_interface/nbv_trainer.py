...
class NBVTrainer(Trainer):
    ...
    def setup(self, test_mode: Literal["test", "val", "inference"] = "val"):
        ...
        """
        # base_config - dynamic_batch - base_pipeline - instant_ngp - nerfacto_field
    ...
    def train(self):
        ...
        num_iterations = self.config.max_num_iterations # 5000
        ...
        for step in range(self._start_step, self._start_step + num_iterations):
            ...
            with self.train_lock:
                with TimeWriter(writer, EventName.ITER_TRAIN_TIME, step=step) as train_t:
                    self.pipeline.train() # dynamicBatchPipeline 进入训练状态，不是训练
