...
class NBVDataManager(
    ...
    def next_train(self, step: int) -> Tuple[RayBundle, Dict]:
        ...
        batch = self.train_pixel_sampler.sample(image_batch) # sampler是什么
        ray_indices = batch["indices"] # 3364 3 应该是第一张图片的哪个像素来表示射线
        ray_bundle = self.train_ray_generator(ray_indices) # 根据rayindices生成raybundle?
